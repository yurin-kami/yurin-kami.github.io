...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <div class="profile-card">
                            <div class="avatar-wrapper">
                                <div class="avatar-container">
                                    <img src="/images/avatar.jpg" alt="小柳香穗" class="avatar" />
                            ...
                            <div class="profile-info">
                                <h1 class="site-title">KAMISHOW!!!!!</h1>
                                <p class="site-subtitle">小柳香穗的博客</p>
                                <p class="site-bio">个人技术博客</p>

                                <div class="social-links">
                                                    <a href="https://github.com/yurin-kami" target="_blank" class="social-btn github" title="Github">
                                                        <i class="ri-github-fill"></i>
                                                    </a>
                                                    <a href="mailto:2063294262@qq.com" target="_blank" class="social-btn email" title="Email">
    ...
    阅读全文 <i class="ri-arrow-right-s-line"></i>
                    ...
                    <footer class="page-footer">
                        <p>Designed with <i class="ri-heart-3-fill heart-beat"></i> by 小柳香穗</p>
                        <p class="copyright">
